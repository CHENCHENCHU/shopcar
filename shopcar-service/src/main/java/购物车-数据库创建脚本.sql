DROP DATABASE ccc ;
CREATE DATABASE ccc CHARACTER SET UTF8 ;
USE ccc ;
-- 创建数据表
CREATE TABLE member  (
...
CREATE TABLE orders (
   ...
   CONSTRAINT fk_cid5 FOREIGN KEY(cid) REFERENCES city(cid) ON DELETE CASCADE 
) engine=innodb;
-- 创建订单详情
...
-- 增加用户：admin/hello
INSERT INTO member(mid,name,password) VALUES ('admin','管理员','EAB62A7769F0313F8D69CEBA32F4347E') ;
-- 增加用户：mldn/java
INSERT INTO member(mid,name,password) VALUES ('mldn','用户','D6DBB9093F83091B1EB3109197659FDE') ;
